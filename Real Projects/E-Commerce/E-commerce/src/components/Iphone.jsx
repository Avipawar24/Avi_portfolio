  ...
  return (
    <div>
        ...
        <div className='border-1 w-full h-60 flex justify-between items-center'>
          <h1 className='text-9xl font-semibold'>iPhone</h1>
          <div className='text-3xl font-semibold w-72 mr-10'>
          <h3>Designed to be loved.</h3>
          </div>
        </div>
        <video autoPlay loop muted src="https://www.apple.com/105/media/ww/iphone/family/2024/cf19f185-dd7e-4350-97ff-e44860713b54/anim/welcome/large_2x.mp4"></video>
        ...
        {iphone.map((item,index)=>(<div className='' key={item.id}>
